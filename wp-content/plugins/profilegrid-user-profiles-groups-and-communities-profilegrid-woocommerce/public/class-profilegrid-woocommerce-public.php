...
class Profilegrid_Woocommerce_Public {
    ...
    public function pg_purchases_tab($id,$newtab,$uid,$gid)
    {
        if($id=='pg-woocommerce_purchases' && isset($newtab) && $newtab['status']=='1'):
           ...
           {
               echo '<li class="pm-profile-tab pm-pad10"><a class="pm-dbfl" href="#pg-woocommerce_purchases">'. __($newtab['title'],'profilegrid-woocommerce').'</a></li>';
           }
        endif;
    }
    ...
    public function pg_cart_tab($id,$newtab,$uid,$gid)
    {
        if($id=='pg-woocommerce_cart' && isset($newtab) && $newtab['status']=='1'):
            ...
            if($dbhandler->get_global_option_value('pm_enable_woocommerce','0')==1 && $dbhandler->get_global_option_value('pm_enable_cart_tab','1')==1 && $current_uid == $uid)
            {
                echo '<li class="pm-profile-tab pm-pad10"><a class="pm-dbfl" href="#pg-woocommerce_cart">'. __($newtab['title'],'profilegrid-woocommerce').'</a></li>';
            }
        endif;
    }
    ...
    public function pg_product_review_tab($id,$newtab,$uid,$gid)
    {
        if($id=='pg-woocommerce_reviews' && isset($newtab) && $newtab['status']=='1'):
            ...
            {
                echo '<li class="pm-profile-tab pm-pad10"><a class="pm-dbfl" href="#pg-woocommerce_reviews">'. __($newtab['title'],'profilegrid-woocommerce').'</a></li>';
            }
        endif;
    }
