...
<!--			<span class="pg-woocommerce-salescount" title="<?php _e('Total Sales','profilegrid-woocommerce'); ?>"><i class="pg-favicon-shopping-cart"></i><?php echo $total_sales; ?></span>-->
			<span class="pg-woocommerce-stock_state <?php echo 'pg_'.$stock_status;?>"><?php echo $stock_state; ?></span>
		</span>
