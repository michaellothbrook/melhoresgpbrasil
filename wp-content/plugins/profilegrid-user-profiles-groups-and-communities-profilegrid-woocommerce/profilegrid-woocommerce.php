...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker('http://profilegrid.co/woocommerce_metadata.json', __FILE__, 'profilegrid-user-profiles-groups-and-communities-profilegrid-woocommerce');
