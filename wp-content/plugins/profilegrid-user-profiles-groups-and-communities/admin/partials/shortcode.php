...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <div class="pmagic pg-wide-wrap">
        ...
        <div class="pg-notice pg-alert pg-shortcode-alert">You can also find list of all ProfileGrid shortcodes in <a href="https://profilegrid.co/wordpress-user-profiles-shortcodes-list/" target="_blank">this post</a> with screenshots.</div>
            ...
            <div class="pg-escblock-title"><b><?php _e("ProfileGrid",'profilegrid-user-profiles-groups-and-communities');?></b> <span class="pg-blue"><?php _e("Basic Shortcodes",'profilegrid-user-profiles-groups-and-communities');?></span></div>
   ...
   <!---  Basic Short code --->
       ...
       <div class="pg-escsubblock">
        ...
        <div class="pg-escblock">
            <div class="pg-scblock-pg-logo"><img src="<?php echo $path;?>images/pg-sc-logo.png"></div>
            <div class="pg-escblock-title"><b><?php _e("ProfileGrid",'profilegrid-user-profiles-groups-and-communities');?></b> <span class="pg-blue"><?php _e("Advanced Shortcodes",'profilegrid-user-profiles-groups-and-communities');?></span></div>
          ...
          <div class="pg-scblock-hide" style="display: none;">
           ...
           <div class="pg-scblock pg-shorocode-show-less" style="display: none;">
            <?php _e("Less info",'profilegrid-user-profiles-groups-and-communities');?>
               ...
               <div class="pg-escblock">
                  <div class="pg-scblock-pg-logo"><img src="<?php echo $path;?>images/pg-sc-logo.png"></div>
            <div class="pg-escblock-title"><b><?php _e("ProfileGrid",'profilegrid-user-profiles-groups-and-communities');?></b> <span class="pg-blue"><?php _e("Email Shortcodes",'profilegrid-user-profiles-groups-and-communities');?></span></div>
