...
<div class="uimagic">
    ...
    <div class="content">
      ...
      <div class="uimsubheader">
        ...
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show Register Link on Login Form','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php printf(__('When enabled, Register link appear on Login Form.','profilegrid-user-profiles-groups-and-communities'),'https://gravatar.com');?></div>
      </div>
